...
#elif defined(__AVR_ATmega48__) || defined(__AVR_ATmega88__) || defined(__AVR_ATmega168__) || defined(__AVR_ATmega48A__) || defined(__AVR_ATmega88A__) || defined(__AVR_ATmega168A__)
 #define ATMEGA_USART0
 #define RXCIE 			RXCIE0
 #define TXCIE 			TXCIE0
 #define RXEN 			RXEN0
 #define TXEN 			TXEN0
 #define UART0_RECEIVE_INTERRUPT	_VECTOR(18)
 #define UART0_TRANSMIT_INTERRUPT	_VECTOR(19)
