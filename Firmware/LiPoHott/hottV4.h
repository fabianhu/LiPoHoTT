...
struct HOTT_GAM_MSG {
	uint8_t start_uint8_t;			//#01 start uint8_t constant value 0x7c
...
struct HOTT_VARIO_MSG {
	...
	uint8_t version;				//#43 version number TODO: more info?
	uint8_t stop_uint8_t;				//#44 stop uint8_t, constant value 0x7d
...
struct HOTT_EAM_MSG {
	uint8_t start_uint8_t;			//#01 start uint8_t
	...
	uint8_t speed_H;				//#42
	uint8_t stop_uint8_t;				//#43 stop uint8_t
...
struct HOTT_GPS_MSG {
	uint8_t start_uint8_t;      //#01 constant value 0x7c
	...
	// 1	Gyro Receiver
	// 255 Mikrokopter
	uint8_t end_uint8_t;  //#44 constant value 0x7d
